				...
				<TR>
					...
					<TD vAlign=top width="100%" bgColor=#ffffff>
						<TABLE cellSpacing=0 cellPadding=5 width="100%" border=0>
							<TR>
								<TD class=manageHead>Current location: Contact management &gt; add contact</TD>
							</TR>
							<TR>
								<TD height=2></TD>
							</TR>
						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<td>
								<input type="radio" value="1" name="lkmGender">Male
								<input type="radio" value="2" name="lkmGender">Female
								</td>
							</TR>
							<TR>
								<td>contact phone#</td>
