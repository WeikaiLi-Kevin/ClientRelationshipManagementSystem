			...
			<TBODY>
				<TR>
					...
					<TD align=middle width=180 background=images/new_006.jpg
						height=35><B>Human Resources - Function Menu</B></TD>
							...
							<TBODY>
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_1');"><SPAN
										class=span id=table_1Span>＋</SPAN> Client Management</TD>
								</TR>
								<TR>
									<TD>
								...
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_2');"><SPAN
										class=span id=table_2Span>＋</SPAN> Contact Management</TD>
								</TR>
								<TR>
									<TD>
								...
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_5');"><SPAN
										class=span id=table_5Span>＋</SPAN> Client Visit management</TD>
								</TR>
								<TR>
									<TD>
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="#"
														target=main>－New Visit</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="#"
														target=main>－Visit List</A></TD>
												</TR>
								...
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_3');"><SPAN
										class=span id=table_3Span>＋</SPAN> Integrated Query</TD>
								</TR>
								<TR>
									<TD>
										<TABLE id=table_3 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="#"
														target=main>－ Client Info Query</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="#"
														target=main>－ Contact Info Query</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="#"
														target=main>－ Visit Info Query</A></TD>
												</TR>
											</TBODY>
										</TABLE>
									</TD>
								...
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_4');"><SPAN
										class=span id=table_4Span>＋</SPAN> Statistic Analysis</TD>
								</TR>
								<TR>
									<TD>
										<TABLE id=table_4 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="#"
														target=main>－Client's Industry</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="#"
														target=main>－Client's source</A></TD>
												</TR>
								...
								<TR>
									<TD class=mainMenu onClick="MenuDisplay('table_6');"><SPAN
										class=span id=table_6Span>＋</SPAN>System Management</TD>
								</TR>
								<TR>
									<TD>
										<TABLE id=table_6 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												<TR>
													<TD class=menuSmall><A class=style2 href="#"
														target=main>－Role Management</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="#"
														target=main>－User Management</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall><A class=style2 href="#"
														target=main>－Data Dictionary</A></TD>
												</TR>
											</TBODY>
										</TABLE>
									</TD>
